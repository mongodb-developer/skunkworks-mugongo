      ...
      <div className="content">
        ...
        <div className="user-details">
          ...
          <div className="input-box">
            ...
            <input type="text" placeholder="Enter organizer email" required />
          </div>
          <div className="input-box">
        ...
        <div className="role-details">
          ...
          <span className="gender-title">Community/Staff</span>
          <div className="category">
            <label for="dot-1">
              <span className="dot one"></span>
              <span className="gender" value="Community">Community</span>
            </label>
            <label for="dot-2">
              <span className="dot two"></span>
              <span className="gender" value="Staff">Staff</span>
            </label>
          </div>
        </div>
