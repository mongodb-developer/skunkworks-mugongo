          ...
          <TableBody>
            {Events.slice(
              ...
              >
                ...
                <StyledTableCell align="center">
                  {event.staffOrCommunity}
                </StyledTableCell>
                <StyledTableCell align="center">
                  {event.isMeetingDone.toString()}
                </StyledTableCell>
                <StyledTableCell align="center">
                  {event.isGroupSet.toString()}
                </StyledTableCell>
                <StyledTableCell align="center">
                  {event.lastEventDate
                    ? event.lastEventDate.toLocaleString().substring(0, 10)
                    : ""}
                </StyledTableCell>
                <StyledTableCell align="center">
                  {event.activeDate
                    ? event.activeDate.toLocaleString().substring(0, 10)
                    : ""}
                </StyledTableCell>
              </StyledTableRow>
            ))}
